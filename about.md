...
But wait, there’s more! Since 2003 I have been involved in building software for just over 22 years now and that has included projects from IoT & embedded systems to large-scale enterprise applications. I am a huge fan of the open-source software development model, and in scientific computing specifically I'm firmly on the side of open-source and open-science. Just look at the <a target="_blank" href="http://tuxriders.com/">TuxRiders</a> project for a good  example.
